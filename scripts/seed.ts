...
const users = [
  ...
  { email: 'jonas@example.com', password: 'password123', username: 'jonskern', display_name: 'Jonas Kern', avatar_color: '#6600CC', bio: 'UX & Design' },
  { email: 'sara@example.com', password: 'password123', username: 'saravoss', display_name: 'Sara Voss', avatar_color: '#AA44FF', bio: 'Full-stack dev' },
  { email: 'tobias@example.com', password: 'password123', username: 'tobiauer', display_name: 'Tobias Auer', avatar_color: '#550099', bio: 'Infrastructure' },
  { email: 'lena@example.com', password: 'password123', username: 'lenabraun', display_name: 'Lena Braun', avatar_color: '#CC77FF', bio: 'Product thinker' },
];
